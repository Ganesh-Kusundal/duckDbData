...
class BreakoutRuleTemplates:
    ...
    def get_standard_breakout_rule(
        ...
        return {
            ...
            "conditions": {
                "time_window": {
                    "start": config.get_signal_time_window_start(),
                    "end": config.get_cutoff_time()
                },
                "breakout_conditions": {
                    "min_price_move_pct": config.get_breakout_price_move_min(),
                    "max_price_move_pct": config.get_breakout_price_move_max(),
                    "min_volume_multiplier": config.get_breakout_volume_multiplier_min(),
                    "volume_comparison_period": config.get_breakout_volume_comparison_period(),
                    "breakout_direction": "up"
                },
                "market_conditions": {
                    "min_price": config.get_breakout_min_price(),
                    "max_price": config.get_breakout_max_price(),
                    "min_volume": config.get_breakout_min_volume()
                }
            },
            "actions": {
                "signal_type": "BUY",
    ...
    def get_aggressive_breakout_rule(
        ...
        return {
            ...
            "conditions": {
                ...
                "breakout_conditions": {
                    "min_price_move_pct": config.get_breakout_price_move_min() * 2,  # More aggressive
                    "max_price_move_pct": config.get_breakout_price_move_max(),
                    "min_volume_multiplier": config.get_breakout_volume_multiplier_max(),
                    "volume_comparison_period": config.get_breakout_volume_comparison_period(),
                    "breakout_direction": "up"
                },
                "market_conditions": {
                    "min_price": config.get_breakout_min_price(),
                    "max_price": config.get_breakout_max_price(),
                    "min_volume": config.get_breakout_min_volume() * 2  # Higher volume requirement
                }
            },
            "actions": {
                "signal_type": "BUY",
